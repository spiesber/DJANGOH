...
C---PRINT THE TITLE
 ...
 9    FORMAT(
     ...
     6//,10X,'                 VERSION 4.6.22, 16.12.2024 '//
     8//,10X,'                      H. Spiesberger '//
     9' **************************************************',
     1'****************************',//)
C
...
C                                  INCLUDING F_L
 ...
 522     CONTINUE
 521    CONTINUE
        CQP(1) =  QU *AUP - HPOLAR*DQU *GUP
        CQP(2) =  QBU*AUM - HPOLAR*DQBU*GUM + CQP(1)
        CQP(3) =  QD *ADP - HPOLAR*DQD *GDP + CQP(2)
        CQP(4) =  QBD*ADM - HPOLAR*DQBD*GDM + CQP(3)
        CQP(5) =  QS *ADP - HPOLAR*DQS *GDP + CQP(4)
        CQP(6) =  QBS*ADM - HPOLAR*DQBS*GDM + CQP(5)
        CQP(7) =  QC *AUP - HPOLAR*DQC *GUP + CQP(6)
        CQP(8) =  QBC*AUM - HPOLAR*DQBC*GUM + CQP(7)
        CQP(9) =  QB *ADP - HPOLAR*DQB *GDP + CQP(8)
        CQP(10) = QBB*ADM - HPOLAR*DQBB*GDM + CQP(9)
        CQP(11) = QT *AUP - HPOLAR*DQT *GUP + CQP(10)
        CQP(12) = QBT*AUM - HPOLAR*DQBT*GUM + CQP(11)
        SUMME=CQP(12)
        SUMME=0D0
        DO 531 IB1=1,2
         DO 532 IB2=1,2
